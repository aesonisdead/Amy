...
emoji = '😏💦'
description = percentages < 50 ? `🧡 Calculations have shown that ${userId} is *${percentages}%* ${command} ${emoji}\n> ✰ Maybe you need more hobbies!` : percentages > 100 ? `💕 The calculations have shown that ${userId} is *${percentages}%* ${command} ${emoji}\n> ✰ That's admirable resilience!` : `💞 The calculations 
break
case 'hoe': case 'bitch':
emoji = '🔥🥵'
