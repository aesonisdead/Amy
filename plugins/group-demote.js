...
if (!user) return conn.reply(m.chat, `❀ You must mention an user to be able to demote them from administrator.`, m)
try {
...
conn.reply(m.chat, `❀ The user is no longer an admin.`, m)
} catch (e) {
